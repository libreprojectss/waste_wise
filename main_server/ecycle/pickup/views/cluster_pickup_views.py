...
from pickup.helpers.assign_picker import assign_picker
...
def get_priority_queue():
    ...
    pickups_objs=pickups.objects.all()
    coordinates=[{"lat":pickup.lat,"lng":pickup.lng,"pickup_identifier":pickup.id} for pickup in pickups_objs]
